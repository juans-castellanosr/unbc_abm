...
>
    ...
    >
        <div class="absolute inset-0 bg-[#0f172a] opacity-75"></div>
    </div>

    <div
        x-show="show"
        class="mb-6 bg-[#1e293b] rounded-xl overflow-hidden shadow-xl transform transition-all sm:w-full {{ $maxWidth }} sm:mx-auto border border-[#475569]"
        x-transition:enter="ease-out duration-300"
